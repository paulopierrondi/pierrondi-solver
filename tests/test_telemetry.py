...
def test_log_and_summary(tmp_path):
    ...
    tel.log_attempt(AttemptLog("pierrondi", "recaptcha_v2", "v2_audio", "https://x.com/p", "B",
                               8300, 0.0, True, token="SECRET-TOKEN-123",
                               purpose="read_only", operation_id="check-42"))
    tel.log_attempt(AttemptLog("capsolver", "recaptcha_v2", "task_api", "https://x.com/p", "B",
...
def test_token_never_stored_raw(tmp_path):
    tel = make_telemetry(tmp_path)
    tel.log_attempt(AttemptLog("pierrondi", "recaptcha_v2", "v2_audio", "https://x.com", "B",
...
def test_site_host_extracted(tmp_path):
    tel = make_telemetry(tmp_path)
    tel.log_attempt(AttemptLog("pierrondi", "recaptcha_v2", "v2_audio",
