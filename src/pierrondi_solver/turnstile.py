...
class TurnstileStrategy:
    ...
    def __init__(self, headless: bool = True, proxy_backend: ProxyBackend | None = None) -> None:
    ...
    def solve(self, request: SolveRequest) -> StrategyOutcome:
        ...
        try:
            token = self._harvest_token(request.page_url, request.timeout_s, proxy_cs)
    ...
    def _harvest_token(self, page_url: str, timeout_s: int, proxy: str = "") -> str:
